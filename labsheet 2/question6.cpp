...
#include<iostream>
using namespace std;
float updatedsalary(float a, int b){

    return a+(float)b/100*a;
}
int main(){
    float CEO=35000,a=2000 ;
    float IO=25000;
    float SA=24000;
    float P=18000;
    int p1=9;
    ...
    cout<<"The updated salary of system analyst is"<<updatedsalary(SA,p3)<<endl;
    cout<<"The updated salary of programmer is"<<updatedsalary(P,p4)<<endl;
